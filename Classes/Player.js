import {State, IdleRight, IdleLeft, RunRight, RunLeft} from './States.js'
//, JumpRight, JumpLeft, FallRight, FallLeft, states
export default class Player {
    ...
    draw (context_2D) {
        context_2D.drawImage(this.current_state.image, this.crop_frame_width*this.current_frame, 0,
            this.crop_frame_width, this.crop_frame_height, this.x, this.y, this.crop_frame_width, this.crop_frame_height)

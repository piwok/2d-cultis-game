...
const player = new Player({x: 350, y: 0}, {width: 50, height: 150, color: 'red'}, context_2D, {}, {},
                    {width: 150, height: 40, color: 'black', rel_pos_x: 50, rel_pos_y: 0, attack: false, duration: 1000, damage: 1}, 0.45);
const controller = new KeyboardController(player);
const cultist = new Monster ({x: 1000, y: 0}, {width: 50, height: 150, color: 'purple'}, context_2D, {}, {}, {width: 150, height: 40, attack: false, duration: 1000, damage: 1}, 0.05);
for (let i = 0; i < 30; i++) {
